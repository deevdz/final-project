...
class TestBlogModel(TestCase):
    ...
    def test_can_create_a_featured_blog_post(self):
        blog = Blog(title='Create a Test Blog',
                    content='This is a test blog post', featured=True,
                    tags='Test', user_id=1)
    ...
    def test_can_create_a_comment(self):
        comment = Comment(user_id=1, content='Testing',
                          blog_id=2, approved=False)
        comment.save()
...
class TestBlogViews(TestCase):
    ...
    def test_get_blog_post_page(self):
        test = Blog.objects.create(title='Test Blog', slug='testing-2',
                                   featured=True, user_id=1, image='test.png',)
    ...
    def test_get_category_page(self):
        ...
        page = self.client.get(reverse('list_blog_by_category',
                                       args=(test.slug,)))
        self.assertEqual(page.status_code, 200)
